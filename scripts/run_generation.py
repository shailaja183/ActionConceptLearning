...
import argparse
import sys
sys.path.append('/content/drive/MyDrive/action-commonsense/')
...
def main():
    ...
    parser.add_argument("--split", default=None, type=str, required=True, choices=['val', 'test','custom'],
    ...
    #print("*** main", args.model_name_or_path)
    ...
    for input_record, (
        ...
        if idx < 30:
            ...
            print("Text Description: {}".format(output_record['event']))
